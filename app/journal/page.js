...
export default function Journal() {
    ...
    return (
        <main className='flex align-top flex-col items-center md:text-center mx-10 md:mx-16 lg:mx-32 md:my-10 lg:my-20'>
            ...
            <p className={contentFont + "animate__animated animate__fadeInDown animate__delay-1s"}>
            ...
            <p className={contentFont + "animate__animated animate__fadeInDown animate__delay-1s"}>
                So if you like to read, consider going through my posts and let me know what your think.
            </p>
                ...
                <ul className='list-none my-10'>
                    {
                        db.map((item, index) => {
                            ...
                            return (
                                <li key={index} id={`${item}`} className='mb-14 relative text-gray-700 text-xl py-3 pb-1 px-6 no-underline after:bg-gray-600 after:absolute after:h-px after:w-0 after:bottom-0 after:left-0 hover:after:w-full after:transition-all after:duration-300 cursor-pointer' >
                                    <Link href={`./journal/${item.id}`} className=''>
                                        <div className='flex justify-between '>
                                            <h1 className='text-2xl md:text-3xl mb-2 no-underline text-gray-700'>
                                                {item.title}
                                            </h1>
                                        </div>
                                        <div className={contentFont2 + "text-left no-underline"}>
                                            {item.date}
                                        </div>
                                        <div className={contentFont2 + "text-left no-underline"}>
                                            {item.content.at(0)}.....
